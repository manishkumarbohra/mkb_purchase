...
Lock multiple locked Purchase Orders in one go from the Purchase Orders list view.

---

## Features

- Adds an **Action ▸ Lock Purchase Orders** option in the Purchase Orders list view.
- Select several locked purchase orders at once and Lock them in bulk.
...
3. Install **Bulk Lock Purchase Orders**.
...
3. Select the locked Purchase Orders you want to Lock.
4. Click **Action ▸ Lock Purchase Orders**.
5. The selected Purchase Orders will be Locked immediately.

> Notes:  
> - Only orders in the **Locked** state will be Locked.  
...
- Draft RFQs or already Locked orders are skipped.  
